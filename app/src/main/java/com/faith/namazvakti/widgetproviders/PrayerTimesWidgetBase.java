...
import com.faith.namazvakti.services.WidgetUpdaterService;
...
abstract public class PrayerTimesWidgetBase extends AppWidgetProvider {
    public static final String UPDATE_ACTION = "com.faith.namazvakti.services.WidgetUpdaterService.UPDATE";
